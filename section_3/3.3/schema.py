...
class ResumeExtract(BaseModel):
    ...
    skills: List[str] = Field(default_factory=list, description="Normalized skills list (lowercase)")
    education: Optional[str] = Field(None, description="Highest degree or main education summary")
...
class HRDecision(BaseModel):
    ...
    improvements: List["str"] = Field(description="Suggestions for candidate improvements")
